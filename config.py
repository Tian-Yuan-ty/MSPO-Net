...
def cfg():
    ...
    if mode == 'train':
        ...
        notrain = False
        snapshot = './runs/MSPONet_VOC_sets_0_1way_1shot_[train]/1/snapshots/20000.pth'
        n_runs = 5
        n_steps = 10
        batch_size = 1
        scribble_dilation = 0
    ...
    path = {
        ...
        # 'init_path': './pretrained_model/resnet101-63fe2227.pth',
